...
bsub -Is -R 'select[port8080=1]' -q general-interactive -a 'docker(themadstatter/washu-ris-ris-registry-shared-rstudio:4.1.2)' supervisord -c /app/supervisord.conf
